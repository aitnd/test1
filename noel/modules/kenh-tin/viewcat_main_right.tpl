...
<div class="news_column">
    <div class="news-content bordersilver white clearfix">
        ...
        <div class="{WCT}{BORDER}items clearfix">
            <h3><a target="_blank" title="{CONTENT.title}" href="{CONTENT.link}">{CONTENT.title}</a></h3>
            <!-- BEGIN: image -->
            <a target="_blank" title="{CONTENT.title}" href="{CONTENT.link}"><img src="{CONTENT.imghome}" alt="{CONTENT.title}" width="{IMGWIDTH}" /></a>
            <!-- END: image -->
            <p>
                {CONTENT.hometext}
            </p>
