<!-- BEGIN: main -->
	<!-- BEGIN: block_tc-->
	<form id="searchtc" name="searchtc" method="post" align="center">
	<div align="center">	
		<select name="tcid" >
			<option value=0>Chọn tổ chức cần xem</option>
		<!-- BEGIN: loop_ds-->
			<option value={TCID} {SEL}>{TENTC}</option>
		<!-- END: loop_ds -->
		</select>
	...
	<br />
	<div class="total">Tổng cộng có <b>{TOTAL}</b> thành viên thuộc tổ chức <b>{THUOCTC}</b></div>
<!-- END: main -->